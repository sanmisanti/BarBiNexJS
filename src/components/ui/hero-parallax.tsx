...
export const HeroParallax = ({
  ...
  return (
    <div
      ref={ref}
      className="h-[300vh] max-w-[96vw] overflow-hidden  antialiased relative flex flex-col self-auto [perspective:1000px] [transform-style:preserve-3d]"
    >
      <Header />
  ...
  return (
    <div className="max-w-7xl relative mx-auto py-5 md:py-40 px-4 w-full  left-0 top-0">
      ...
      <p className="max-w-2xl text-base md:text-xl mt-8 dark:text-neutral-200">
        ...
        efiencia, gracias a nuestros concejos y soluciones
      </p>
    </div>
  );
};
